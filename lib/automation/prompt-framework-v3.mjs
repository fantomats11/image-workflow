...
export function buildSupportPromptV3(item = {}, shotKey, index, total) {
  ...
  return [
    ...
    hasApprovedHeroAnchor ? "ภาพต้องดูเป็นเซ็ตเดียวกับภาพหลัก สินค้าเป็นจุดเด่นหลัก ไม่ต้องใส่ข้อความ ไม่ต้องแบ่งกริด ไม่ต้องแบ่งช่อง" : "สินค้าเป็นจุดเด่นหลัก ภาพสมจริง สะอาดตา ไม่ต้องใส่ข้อความ ไม่ต้องแบ่งกริด ไม่ต้องแบ่งช่อง"
  ].filter(Boolean).join("\n");
}
...
function describeLeanThaiSupportShotV3(shotKey = "", item = {}) {
  ...
  const descriptions = {
    ...
    side_fit_on_model: "นางแบบสวมสินค้าจากมุมด้านข้างหรือเฉียง 45 องศา ให้เห็นทรง ความหนา ความยาว การเข้ารูปจริง และโลโก้ แพตช์ ตัวเลข หรือข้อความเทคนิคจริงบนแขนถ้ามีในภาพต้นฉบับ",
    back_fit_on_model: "นางแบบสวมสินค้าจากมุมด้านหลัง ให้เห็นดีไซน์ด้านหลัง ฮู้ด ทรงไหล่ ความยาว ตะเข็บ โลโก้ แพตช์ ตัวเลข หรือข้อความเทคนิคจริงที่ภาพหลักไม่เห็น",
