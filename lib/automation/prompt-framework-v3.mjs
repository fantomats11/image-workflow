...
function buildLeanThaiSupportPresentationLine(shotKey = "", hasApprovedHeroAnchor = false) {
  ...
  if (backShots.has(shotKey)) {
    return "ใช้ฉาก studio ขาวหรือเทาอ่อนสะอาดแบบหน้าสินค้า ยึดภาพด้านหลังต้นฉบับเป็น visual truth ห้ามดึงฉาก lifestyle จาก Hero มาใช้ และห้ามเปลี่ยนเป็นหุ่นโชว์ ดัมมี่ หรือ ghost mannequin เว้นแต่ภาพต้นฉบับเป็นหุ่นจริง";
  }
  if (sideShots.has(shotKey)) {
    return "ใช้ฉาก studio ขาวหรือเทาอ่อนสะอาดแบบหน้าสินค้า ไม่ต้องยกฉาก lifestyle ของ Hero มาใหม่ ไม่มีหิมะ ถนน ต้นไม้ หรือฉากยุ่ง คุมแสง สี และความสมจริงให้ต่อเนื่องกับภาพหลัก";
  }
  ...
  return hasApprovedHeroAnchor
    ? "ใช้ฉาก studio ขาวหรือเทาอ่อนสะอาดแบบหน้าสินค้า ภาพต้องดูเป็นเซ็ตเดียวกับภาพหลักในแสง สี และความสมจริง แต่ไม่ต้องยกฉาก lifestyle ของ Hero มาใหม่ ไม่ต้องใส่ข้อความ ไม่ต้องแบ่งกริด ไม่ต้องแบ่งช่อง"
