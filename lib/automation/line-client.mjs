...
export function buildHeroReviewMessages({
  ...
  messages.push({
    ...
    quickReply: {
      items: [
        quickReplyPostback("Approve hero", { action: "approve_hero", batch_id: resolvedBatchId, sku, generation_id: heroAsset.generation_id || "" }),
        quickReplyPostback("Regenerate", { action: "regenerate_hero", batch_id: resolvedBatchId, sku, generation_id: heroAsset.generation_id || "" }),
        ...(reviewUrl ? [quickReplyUri("Open review page", reviewUrl)] : [])
      ]
    }
  });
