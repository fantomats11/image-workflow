const GENERATED_HINT = /(?:^|[\s._-])(generated|output|hero|support|edited|ai|render)(?:[\s._-]|$)/i;
const LABEL_HINT = /(?:^|[\s._-])(label|tag|barcode|sku|skucard|sku\s*card|scan|ป้าย|ป้ายสินค้า|บาร์โค้ด)(?:[\s._-]|$)/i;
const NOISE_HINT = /(?:^|[\s._-])(floor|blur|hand|shelf|bag|noise|พื้น|มือ|ถุง|เบลอ)(?:[\s._-]|$)/i;
